...
public class purchaseorderoutView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_purchaseorder_out_view);
        ...
        if (invoiceButton != null) {
            invoiceButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(purchaseorderoutView.this, purchaseOrderOutActivity.class);
                    startActivity(intent);
                }
            });
        } else {
            showToast("Invoice Button is null");
        }
    ...
    private void performSearch(String query) {
        ...
        firestore.collection("PurchaseOut")
    ...
    private void showToast(String message) {
        Toast.makeText(purchaseorderoutView.this, message, Toast.LENGTH_SHORT).show();
    }
    ...
    private void addDataCard(String name, String total, String date, String documentID) {
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(purchaseorderoutView.this, "Update clicked!", Toast.LENGTH_SHORT).show();
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firestore.collection("PurchaseOut").document(documentID)
                        .delete()
