...
public class Quotation_Main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quotation_main);
        ...
        invoiceButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Quotation_Main.this,Quotation.class);
    ...
    private void fetchData() {
        ...
        Toast.makeText(Quotation_Main.this, message, Toast.LENGTH_SHORT).show();
    }
    private void addDataCard(String name, String total, String date, String documentID) {
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Quotation_Main.this, "Update clicked!", Toast.LENGTH_SHORT).show();
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firestore.collection("QuatationProduct").document(documentID)
                        .delete()
