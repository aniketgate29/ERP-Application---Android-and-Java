...
public class Invoice_View extends AppCompatActivity {
    ...
    private static final String FIELD_TOTAL_AMOUNT = "Amount";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        invoiceButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Invoice_View.this, InvoiceActivity.class);
    ...
    private void fetchData() {
        ...
        Toast.makeText(Invoice_View.this, message, Toast.LENGTH_SHORT).show();
    }
    private void addDataCard(String name, String total, String date, String documentID) {
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Invoice_View.this, "Update clicked!", Toast.LENGTH_SHORT).show();
