...
public class SaleReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productEntries1 = findViewById(R.id.invoice1);
    ...
    private void showToast(String message) {
        Toast.makeText(SaleReportActivity.this, message, Toast.LENGTH_SHORT).show();
    }
    ...
    private void showDatePickerDialog(final EditText editText) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(SaleReportActivity.this,
    ...
    private void addDataCard(String name, String total, String date) {
        View productCardView = getLayoutInflater().inflate(R.layout.activity_sale1, null);
