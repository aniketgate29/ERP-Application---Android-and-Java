...
public class purchasereturnView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_purchase_return_view);
        ...
        textView.setText("Purchase Report");
        ...
        if (invoiceButton != null) {
            invoiceButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(purchasereturnView.this, purchaseReturnActivity.class);
    ...
    private void showToast(String message) {
        Toast.makeText(purchasereturnView.this, message, Toast.LENGTH_SHORT).show();
    }
    ...
    private void addDataCard(String name, String total, String date, String documentID) {
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(purchasereturnView.this, "Update clicked!", Toast.LENGTH_SHORT).show();
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firestore.collection("PurchaseReturn").document(documentID)
                        .delete()
