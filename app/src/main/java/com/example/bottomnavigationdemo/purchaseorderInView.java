...
public class purchaseorderInView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_purchaseorder_in_view);
        ...
        textView.setText("Purchase Orders ");
        ...
        if (invoiceButton != null) {
            invoiceButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(purchaseorderInView.this, purchaseOrderInActivity.class);
    ...
    private void showToast(String message) {
        Toast.makeText(purchaseorderInView.this, message, Toast.LENGTH_SHORT).show();
    }
    ...
    private void addDataCard(String name, String total, String date, String documentID) {
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(purchaseorderInView.this, "Update clicked!", Toast.LENGTH_SHORT).show();
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firestore.collection("poIN").document(documentID)
                        .delete()
