...
public class CompanyViewActivity extends AppCompatActivity {
    ...
    private static final String FIELD_CUSTOMER_NAME = "companyName";
    private static final String FIELD_TOTAL_AMOUNT = "city";
    private static final String FIELD_DATE = "phoneNumber";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Button
        Button invoiceButton = findViewById(R.id.regbtn);
        fetchData();
        // Set onClickListener for the Button
        invoiceButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CompanyViewActivity.this, CompanyActivity.class);
    ...
    private void performSearch(String query) {
        ...
        firestore.collection("CompanyMaster")
    ...
    private void fetchData() {
        ...
        Toast.makeText(CompanyViewActivity.this, message, Toast.LENGTH_SHORT).show();
    }
    private void addDataCard(String name, String total, String date, String documentID) {
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(CompanyViewActivity.this, "Update clicked!", Toast.LENGTH_SHORT).show();
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firestore.collection("CompanyMaster").document(documentID)
                        .delete()
