...
public class ProductViewActivity extends AppCompatActivity {
    ...
    private static final String FIELD_CUSTOMER_NAME = "productType";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        invoiceButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProductViewActivity.this, AddTypeActivity.class);
    ...
    private void addDataCard(String name,  String documentID) {
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firestore.collection("addType").document(documentID)
                        .delete()
