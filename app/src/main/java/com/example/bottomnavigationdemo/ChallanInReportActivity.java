...
public class ChallanInReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_challanin_report);
    ...
    private void showToast(String message) {
        Toast.makeText(ChallanInReportActivity.this, message, Toast.LENGTH_SHORT).show();
    }
    ...
    private void showDatePickerDialog(final EditText editText) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(ChallanInReportActivity.this,
    ...
    private void addDataCard(String name, String total, String date) {
        View productCardView = getLayoutInflater().inflate(R.layout.challan_in_card, null);
