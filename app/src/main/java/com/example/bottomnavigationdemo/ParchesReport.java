...
public class ParchesReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parches_report);
        ...
        Button sort=findViewById(R.id.sortBtn);
    ...
    private void showToast(String message) {
        Toast.makeText(ParchesReport.this, message, Toast.LENGTH_SHORT).show();
    }
    ...
    private void showDatePickerDialog(final EditText editText) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(ParchesReport.this,
    ...
    private void addDataCard(String name, String total, String date) {
        View productCardView = getLayoutInflater().inflate(R.layout.parches_card, null);
