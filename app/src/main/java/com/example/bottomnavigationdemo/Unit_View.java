...
public class Unit_View extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        invoiceButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Unit_View.this, AddUnitActivity.class);
    ...
    private void fetchData() {
        ...
        Toast.makeText(com.example.bottomnavigationdemo.Unit_View.this, message, Toast.LENGTH_SHORT).show();
    }
    private void addDataCard(String name,  String documentID) {
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firestore.collection("AddUnit").document(documentID)
                        .delete()
